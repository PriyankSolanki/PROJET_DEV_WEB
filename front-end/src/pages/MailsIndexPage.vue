  ...
  <div class="mail-view-container">
    <div class="mail-list">
      <div class="header-row">
        ...
        <button class="send-button" @click="goToSendMail">✉️ Envoyer un mail</button>
      </div>
      ...
      <div class="filter-menu">
        ...
        <button :class="{ active: filter === 'attachments' }" @click="filter = 'attachments'">Avec pièces jointes</button>
      ...
      <div v-else>
        <div
          v-for="mail in visibleFilteredMails"
          :key="mail.id"
          class="mail-preview"
